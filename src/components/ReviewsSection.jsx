...
const ReviewsSection = () => {
  const { t } = useLanguage();
  return (
    <section id="reviews" className="py-24 bg-white dark:bg-warmDark relative transition-colors duration-300">
      {/* Background Pattern */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonialsData.map((review, index) => (
            <motion.div
              ...
              className="bg-white dark:bg-[#1F1C19] p-8 rounded-2xl relative border border-gray-200 dark:border-white/5 hover:border-gold/30 transition-colors duration-300 shadow-md hover:shadow-xl">
            >
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                />
                <div>
                  <h4 className="text-gray-900 dark:text-warmLight font-serif font-bold text-lg">{review.name}</h4>
              ...
              <p className="text-gray-700 dark:text-white/70 italic leading-relaxed">
                "{review.content}"
              </p>
            </motion.div>
          ))}
